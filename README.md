...
*   **🎨 AI 提示词工程**: 内置 32 种专业视觉框架与 7 种企业级主题，支持解耦内容分析与样式渲染，生成高度一致的配图。
*   **🖼️ 智能配图**: 自动解析内容并提取中文文字标签，调用 ComfyUI 或 Google Gemini (Imagen 3) 生成精美图片。
*   **🎬 视频生成**: 将 PPT 转化为配音视频，支持动态索引映射与主流 TTS 模型（MiniMax, Coqui）。
